...
# 데이터프레임과 시트 이름 리스트
dfs = [total_df, total_df2,total_df3,total_df4,total_df5,total_df6,total_df7,total_df8,total_df9]
...
sheet_names = ['사용선수금', '관리선수금','사용료수입','회전관리선수금','월별결산부','사용선수금-일자순','관리선수금-일자순','사용료수입-일자순','회전관리선수금-일자순',]
# 함수 호출
