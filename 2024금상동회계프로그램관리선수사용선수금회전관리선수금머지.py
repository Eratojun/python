...
df16=df6.merge(df7,how="outer",on=["봉안함"])
df16["회전관리선수금"]=df16['대    변']
df16.iloc[:,:].to_excel(f"C:\\dev\\myproj01\\금상동\\결과폴더\\금상동회전관리선수금머지_{input_year}.xlsx")
#save_path2 = f"C:\\dev\\myproj01\\금상동\\결과폴더\\금상동회전관리선수금머지_{input_year}.xlsx" 
#wb.save(save_path2)


# 엑셀 파일 열기
file_path4 = f'C:\\dev\\myproj01\\금상동\\결과폴더\\금상동회전관리선수금머지_{input_year}.xlsx'  # 엑셀 파일 경로를 입력하세요
...
wb.save(file_path4)
file_path5 = f'C:\\dev\\myproj01\\금상동\\결과폴더\\금상동회전관리선수금머지_{input_year}.xlsx'  # 엑셀 파일 경로를 입력하세요
wb = openpyxl.load_workbook(file_path5)
ws = wb.active  # 활성화된 시트를 선택
# 수정된 엑셀 파일 저장
    # A2 셀 기준으로 틀 고정 (freeze panes)
ws.freeze_panes = 'A2'
