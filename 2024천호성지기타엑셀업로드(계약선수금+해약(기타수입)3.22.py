...
if local_ip == "192.168.0.27":  # 사무실에서 사용하는 IP
    file_path30 = r'C:\Users\erato2022\OneDrive\문서\2.금상동천호성지\2024기초데이터\통합조회_20250101천호성지.xlsx'  # 엑셀 파일 경로를 지정하세요
elif local_ip != "192.168.0.27":  # 사무실이 아닌경우 IP
    file_path30 =r'C:\Users\erato\OneDrive\문서\2.금상동천호성지\2024기초데이터\통합조회_20250101천호성지.xlsx'
else:  # 기본 경로 (기타 환경)
...
if local_ip == "192.168.0.27":  # 사무실에서 사용하는 IP
    ...
    file_path31 = r"C:\Users\erato2022\OneDrive\문서\2.금상동천호성지\2024기초데이터\천호성지원본\사용료 현금출납부-2024.xlsx" 
    file_path32 = r"C:\Users\erato2022\OneDrive\문서\2.금상동천호성지\2024기초데이터\천호성지원본\봉안경당매일시재(계약선수금)-2024.xlsx" 
    file_path33 = r"C:\Users\erato2022\OneDrive\문서\2.금상동천호성지\2024기초데이터\천호성지원본\봉안경당 매일시재(봉안)-2024.xlsx" 
    
    
elif local_ip != "192.168.0.27":  # 사무실이 아닌경우 IP
    #input_folder=r"C:\Users\erato\OneDrive\문서\2.금상동천호성지\2024기초데이터\사용료현금출납부-2024"
    #file_path30 =r'C:\Users\erato\OneDrive\문서\2.금상동천호성지\2024기초데이터\통합조회_20241203천호성지.xlsx'
     file_path31 = r"C:\Users\erato\OneDrive\문서\2.금상동천호성지\2024기초데이터\천호성지원본\사용료 현금출납부-2024.xlsx" 
     file_path32 = r"C:\Users\erato\OneDrive\문서\2.금상동천호성지\2024기초데이터\천호성지원본\봉안경당매일시재(계약선수금)-2024.xlsx" 
     file_path33 = r"C:\Users\erato\OneDrive\문서\2.금상동천호성지\2024기초데이터\천호성지원본\봉안경당 매일시재(봉안)-2024.xlsx" 
    #"C:\Users\erato2022\OneDrive\문서\2.금상동천호성지\2024기초데이터\천호성지원본\사용료 현금출납부-2024.xlsx"
else:  # 기본 경로 (기타 환경)
...
if local_ip == "192.168.0.27":  # 사무실에서 사용하는 IP
 ...
 df31 = pd.read_excel(r'C:\Users\erato2022\OneDrive\문서\2.금상동천호성지\2024기초데이터\사용료 현금출납부병합-2024.xlsx',sheet_name="2024년도",skiprows=3,usecols="a:g")
 df32 = pd.read_excel(r'C:\Users\erato2022\OneDrive\문서\2.금상동천호성지\2024기초데이터\봉안경당매일시재(계약선수금)병합-2024.xlsx',sheet_name="2024년도",skiprows=2,usecols="a:g")
 df33 = pd.read_excel(r'C:\Users\erato2022\OneDrive\문서\2.금상동천호성지\2024기초데이터\봉안경당매일시재(봉안)병합-2024.xlsx',sheet_name="2024년도",skiprows=3,usecols="a:g")

elif local_ip != "192.168.0.27":  # 사무실이 아닌경우 IP
  
  df31 = pd.read_excel(r'C:\Users\erato\OneDrive\문서\2.금상동천호성지\2024기초데이터\사용료 현금출납부병합-2024.xlsx',sheet_name="2024년도",skiprows=3,usecols="a:g")
  df32 = pd.read_excel(r'C:\Users\erato\OneDrive\문서\2.금상동천호성지\2024기초데이터\봉안경당매일시재(계약선수금)병합-2024.xlsx',sheet_name="2024년도",skiprows=2,usecols="a:g")
  df33 = pd.read_excel(r'C:\Users\erato\OneDrive\문서\2.금상동천호성지\2024기초데이터\봉안경당매일시재(봉안)병합-2024.xlsx',sheet_name="2024년도",skiprows=3,usecols="a:g")
...
#df31.info()
#df31.to_excel(r'C:\dev\myproj01\금상동\결과폴더\천호성지\사용료현금출납부엑셀정리-2024.xlsx', index=False)
output_file31=r'C:\dev\myproj01\금상동\결과폴더\천호성지\사용료현금출납부엑셀정리-2024.xlsx'
...
#df31.info()
#df31.to_excel(r'C:\dev\myproj01\금상동\결과폴더\천호성지\사용료현금출납부엑셀정리-2024.xlsx', index=False)
output_file32=r'C:\dev\myproj01\금상동\결과폴더\천호성지\봉안경당매일시재(계약선수금)엑셀정리-2024.xlsx'
df32.to_excel(output_file32, index=False)

df33= df33.dropna(subset=["봉안함"]) #아래 누적액,월계액을 없애기위해 회계계정없는부분을 삭제함
#df31.info()
#df31.to_excel(r'C:\dev\myproj01\금상동\결과폴더\천호성지\사용료현금출납부엑셀정리-2024.xlsx', index=False)
output_file33=r'C:\dev\myproj01\금상동\결과폴더\천호성지\봉안경당매일시재(봉안)엑셀정리-2024.xlsx'
...
# 함수 호출
#export_multiple_dfs_to_excel(dfs, sheet_names,'C:\dev\myproj01\금상동\결과폴더\천호성지\월별결산부사용선수금-관리선수금-사용료수입-회전관리선수금2024.xlsx')
output_file34=r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합.xlsx'
export_multiple_dfs_to_excel(dfs, sheet_names,output_file34)
print(f"병합된 데이터가 {output_file34}로 저장되었습니다.")

# 엑셀 파일 경로
file_path35 = r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합.xlsx'
...
# 처리된 데이터프레임을 엑셀로 저장
output_path = r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx'
...
df34 = pd.read_excel(r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx',sheet_name="봉안경당매일시재(계약선수금)",skiprows=0,usecols="a:g")
df35 = pd.read_excel(r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx',sheet_name="봉안경당매일시재(봉안)",skiprows=0,usecols="a:g")
df38 = pd.read_excel(r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx',sheet_name="사용료현금출납부",skiprows=0,usecols="a:h")
...
df38['수입'] = pd.to_numeric(df38['수입'], errors='coerce')
...
###########################################################################################################
#   df34와 df35가 있는 엑셀파일을 불러와서 df35에 봉안함열을 기준으로  병합하되 df34에서  사용료>0  and 비고열에  해약이란 단어를 포함하는 경우만 사용료를 불러와서 병합
# 🎯 조건에 맞는 데이터 필터링 (사용료 > 0 & 비고에 "해약" 포함)
filtered_df34 = df34[(df34['사용료'] < 0) ]

# 📌 필요한 컬럼만 선택 (봉안함, 사용료)
filtered_df34 = filtered_df34[['봉안함', '사용료']]

# 🔄 열 이름 변경: "사용료" → "계약선수금"
filtered_df34 = filtered_df34.rename(columns={'사용료': '계약선수금'})

# 🔗 병합 (봉안함 기준, left join)
df35 = df35.merge(filtered_df34, on="봉안함", how="left")

# 📂 엑셀 파일로 저장
df35.to_excel('C:\dev\myproj01\금상동\결과폴더\천호성지\병합결과.xlsx', index=False)




##############################################################################################################
#  봉안경당매일시재(계약선수금)  계약선수금-b
######## 계약선수금 서식 계약선수금 전체를  인식하기 위한 단계 
####   (-)값은 봉안한 사용선수금이므로 절대값으로 계약선수금을 인식함
...
###########################################################################################################
# 해약환급금처리 
#mask13 = df57["적요명"].str.contains("해약--", na=False)  & (df57["구분1"] == 3)
#mask51 = df34['사용료'] < 0 & (df34['비고'].str.contains("해약", na=False)) 
mask51 = (df34['사용료'] < 0) & (df34['비고'].str.contains("해약", na=False))

# 필터링된 데이터 반복 처리
for _, row in df34[mask51].iterrows():
    new_row1 = {
        '월일': row['월일'],          # 날짜 열에서 값 가져오기
        '구분1': 4,
        '코드1': '101',
...
###########################################################################################################
# 계약선수금 마이너스 처리  차)사용선수금  대)사용료수입입 
#mask13 = df57["적요명"].str.contains("해약--", na=False)  & (df57["구분1"] == 3)
#mask51 = df34['사용료'] < 0 & (df34['비고'].str.contains("해약", na=False)) 
mask52 = df34['사용료'] < 0

# 필터링된 데이터 반복 처리
for _, row in df34[mask52].iterrows():
    new_row1 = {
        '월일': row['월일'],          # 날짜 열에서 값 가져오기
        '구분1': 3,
        '코드1': '275',
...
###########################################################################################################
#봉안경당매일시재(봉안) 서식에서 관리비->관리선수금으로 처리하는 단계
###   천호성지자금흐름   봉안-d
...
##############################################################################################################
#  사용료 현금출납부 -A
########  사용료현금출납부에서 봉안함 수입을 인식하는 단계 


mask38 = ( df38['수입'] > 0) &  (df38['계정']=="봉안함수입")
#  사용선수금 기타엑셀업로드에 추가 조건에 따라 행 추가
# 필터링된 데이터 반복 처리
for _, row in df38[mask38].iterrows():
    new_row1 = {
        '월일': row['월일'],          # 날짜 열에서 값 가져오기
        '구분1': 3,
        '코드1': '101',
        ...
        '거래처명': None,            # 필요시 수정
        '코드5': None,               # 필요시 수정
        '적요명': row['적요'],       # 성명 열에서 값 가져오기
        '금액': (row['수입']),         # 대변 열에서 값 가져오기
        '봉안함': row['봉안함']      # 봉안함 열에서 값 가져오기
    }
...
########################################################################################
#  사용료 현금출납부 -A
########  사용료현금출납부에서 해약-기타수입을 인식하는 단계 


mask38 = ( df38['수입'] > 0) &  (df38['계정']=="기타수입")
#  사용선수금 기타엑셀업로드에 추가 조건에 따라 행 추가
# 필터링된 데이터 반복 처리
for _, row in df38[mask38].iterrows():
    new_row1 = {
...
output_file34=r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호엑셀기타업로드-2024.xlsx'
#df37['적요명'] = df37['적요명'].astype(str) + "**" + df37['봉안함'].astype(str)   
    
output_file35=r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호사용료수입.xlsx'
df35.to_excel(output_file35, index=False)

df36=df35
df36=df36.rename(columns={"사용료":"사용수입"})
...
output_file = 'C:\dev\myproj01\금상동\결과폴더\천호성지\천호엑셀기타업로드-2024.xlsx'  # 여기에 저장할 엑셀 파일의 경로를 입력하세요.
...
# 엑셀 파일 열기
#file_path = r'C:\dev\myproj01\금상동\결과폴더\천호성지\월별결산부사용선수금-관리선수금-사용료수입-회전관리선수금2024.xlsx'  # 엑셀 파일 경로를 입력하세요
file_path = r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx'  # 엑셀 파일 경로를 입력하세요
...
#save_path = r'C:\dev\myproj01\금상동\결과폴더\천호성지\월별결산부사용선수금-관리선수금-사용료수입-회전관리선수금(열조정2024).xlsx'
save_path = r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx'
wb.save(save_path)
...
# 파일 경로 설정
#file_path = r'C:\dev\myproj01\금상동\결과폴더\천호성지\월별결산부사용선수금-관리선수금-사용료수입-회전관리선수금(열조정2024).xlsx'  # 여기에 엑셀 파일 경로 입력
file_path = r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx'
...
if input_year == input_year:
    ...
    mask_10 = (
    df30['봉안일1'].str.contains(input_year, na=False) &  #봉안일1  2024
    (df30['봉안일2'].isna())                              #봉안일2 결측치치
    )

    mask_01 = (
    (df30['봉안일1'].isna()) &  # '봉안일1'이 결측치
    df30['봉안일2'].str.contains(input_year, na=False) #봉안일2가 2024
    )
    
    
    mask_other01 = (
    ~df30['봉안일1'].str.contains(input_year, na=False) &   #이전 true
    df30['봉안일2'].str.contains(input_year, na=False)   # '봉안일1'이 input_year 포함 X
    )
    ...
    combined_mask8 =  (mask_all | mask_10 | mask_01) & (df30['사용수입'] > 0)
    combined_mask9 =  (mask_other01 | mask_other10) & (df30['사용수입'] > 0)


# 조건에 따른 값 설정
    
    #2df30.loc[combined_mask9, new_column_name3] = df30.loc[combined_mask9, '사용수입']
   
    df30['봉안함'] = df30['봉안함'].astype(str)
    df37['봉안함'] = df37['봉안함'].astype(str)


    # '봉안함' 값을 정수형 또는 문자열로 변환
    #df30.loc[combined_mask9, new_column_name3] = df30.loc[combined_mask9].apply(
    #lambda row: row['사용수입'] - df35.loc[df35['봉안함'] == row['봉안함'], '사용료'].values[0]
    #if row['봉안함'] in df35['봉안함'].tolist() else row['사용수입'], axis=1
#)
    ...
    df30.loc[combined_mask8, new_column_name3] = df30.loc[combined_mask8, '사용수입']
    
    df30.loc[mask_other01, new_column_name3] = df30.loc[mask_other01].apply(
    #lambda row: row['사용수입']/2
    #lambda row: row['사용수입']/2  
    lambda row: row['사용수입'] - df36.loc[df36['봉안함'] == row['봉안함'], '사용수입'].values[0]
    if not df36.loc[df36['봉안함'] == row['봉안함'], '사용수입'].empty else row['사용수입']/2,
    axis=1
    )
    
    df30.loc[mask_other10, new_column_name3] = df30.loc[mask_other10].apply(
    lambda row: row['사용수입'] - df36.loc[df36['봉안함'] == row['봉안함'], '사용수입'].values[0]
    if not df36.loc[df36['봉안함'] == row['봉안함'], '사용수입'].empty else row['사용수입'],
    axis=1
    )
    ...
    # 결과 확인
    #print(df30)
    df30=df30.sort_values(["봉안함"]) # 봉안함으로 정렬   # 새로운 파일로 저장
    output_file_path = f"C:\\dev\\myproj01\\금상동\\결과폴더\\천호성지\\천호성지1205_{input_year}.xlsx"
...
# 파일 경로 설정
#a_file = r'C:\dev\myproj01\금상동\결과폴더\천호성지\금상동1205_2024.xlsx'  # a파일 경로
a_file = f"C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\천호성지1205_{input_year}.xlsx"  # a파일 경로

   #f"C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\금상동1205_{input_year}.xlsx"
#b_file = r'C:\dev\myproj01\금상동\결과폴더\천호성지\월별결산부사용선수금-관리선수금-사용료수입-회전관리선수금(열조정2024).xlsx'  # b파일 경로
b_file = r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx'   # b파일 경로
...
output_file = f'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지봉안+기타엑셀업로드병합결과-{today}.xlsx'
...
# 엑셀 파일 열기
file_path = f'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지봉안+기타엑셀업로드병합결과-{today}.xlsx'
wb = openpyxl.load_workbook(file_path)
...
# 모든 시트에 대해 E열부터 G열까지 회계 스타일 적용
    ...
    save_path = f'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지봉안+기타엑셀업로드병합결과-{today}.xlsx' 
    wb.save(save_path)
    print(f"새로운 데이터가 {save_path} 파일로 저장되었습니다.")        

    # 첫 번째 파일 (기존 파일)
file1 = r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호엑셀기타업로드-2024.xlsx'

# 두 번째 파일 (추가할 파일)
file2 = f'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지봉안+기타엑셀업로드병합결과-{today}.xlsx'
...
# 데이터프레임 로드
df_a = pd.read_excel(f'C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\천호성지봉안+기타엑셀업로드병합결과-{today}.xlsx'
)
df47 = pd.read_excel(r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호엑셀기타업로드-2024.xlsx')

df47.to_excel('C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\df47.xlsx', index=False)
...
# 결과 저장
df_a_filtered.to_excel('C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\df_a_filtered.xlsx', index=False)
...
df_grouped57['봉안함'] = df_grouped57['봉안함'].str.rstrip('.0')
df_grouped57.info()
df_grouped57.to_excel('C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\df_grouped57.xlsx', index=False)
...
# 저장
df_grouped57.to_excel('C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\df_result57.xlsx', index=False)
df_a_grouped57.to_excel('C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\df_a_result57.xlsx', index=False)
...
merged_df.to_excel('C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\사용료수입&봉안사용료수입머지.xlsx', index=False)
# 금액 차이 계산
...
merged_df['봉안함']= merged_df['봉안함'].astype(str)
...
df47['봉안함'] = df47['봉안함'].str.rstrip('.0')
# 최종 결과 저장
df47.to_excel('C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\천호성지세무사랑기타업로드버전1227-데이터1203.xlsx', index=False)



    # 첫 번째 파일 (기존 파일)
file2 = r'C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\천호성지세무사랑기타업로드버전1227-데이터1203.xlsx'

# 두 번째 파일 (추가할 파일)
file1 = r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx' 
# 파일을 읽어들임
dfs_file2 = pd.read_excel(file2, sheet_name=None)  # 두 번째 파일의 모든 시트를 딕셔너리로 읽기
...
file_path40=r'C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지엑셀통합일자채움.xlsx'
df40 = pd.read_excel(file_path40)
output_file7 = 'C:\dev\myproj01\금상동\결과폴더\천호성지\천호3장부+엑셀기타업로드-2024.xlsx'  # 여기에 저장할 엑셀 파일의 경로를 입력하세요.
#df40.to_excel(writer, sheet_name="엑셀기타업로드", index=False)  # 새로운 시트로 추가
df40.to_excel(output_file7, index=False)
...
# 엑셀 파일로 저장
updated_df47.to_excel('C:\\dev\\myproj01\\금상동\\결과폴더\천호성지\\updated_df47(2칸출력).xlsx', index=False)
# 결과 저장
...
df47['적요명'] = df47['적요명'].astype(str) + "--" + df47['봉안함'].astype(str)
# 2. 결측값(NaN) 또는 비정상적인 값 제외
df47['월일'] = df47['월일'].replace("", None)  # 빈 문자열 제거
df47['월일'] = pd.to_datetime(df47['월일'], errors='coerce')  # 변환 불가능한 값은 NaT로 대체

df47['월일'] = df47['월일'].dt.strftime('%Y-%m-%d')
df47.to_excel('C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지기타업로드(봉안사용료+관리비연중수입).xlsx', index=False)


df57 = pd.read_excel('C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지기타업로드(봉안사용료+관리비연중수입).xlsx')  # 파일 경로에 맞게 수정

# 조건 1: 적요명에 "해약수수료" 포함 & 구분1 == 4 → 코드1을 930, 계정코드를 "잡이익"으로 변경
mask11 = df57["적요명"].str.contains("해약수수료", na=False) & (df57["구분1"] == 4) & (df57["코드1"] == 101)
df57.loc[mask11, "코드1"] = 930
df57.loc[mask11, "계정코드2"] = "잡이익"
...
df57.to_excel('C:\dev\myproj01\금상동\결과폴더\천호성지\천호성지기타업로드(해약수정03-04.xlsx')  # 저장할 파일명 지정